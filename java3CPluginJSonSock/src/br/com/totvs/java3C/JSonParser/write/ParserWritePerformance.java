...
public class ParserWritePerformance {
	...
	public ParserWritePerformance(String nomeOperacao, String zcaCodAmb, String zcaTipAmb, String zcaItem, String zcaParam, ArrayList<PerformanceInfo> performanceInfoArr) {
		
		String writableStr = "$";
		
		for(PerformanceInfo p : performanceInfoArr ) 
			writableStr += p.getIp() + "#" + p.getPorta() + "#" + p.getEnvironment() + "#" + p.getTipoServico() + "#" + p.getTempo() + "$"; 
		
	
		String writeStr = nomeOperacao + "#" + zcaCodAmb + "#" + zcaTipAmb + "#" + zcaItem + "#" + zcaParam + "#" + writableStr + "#\0";
