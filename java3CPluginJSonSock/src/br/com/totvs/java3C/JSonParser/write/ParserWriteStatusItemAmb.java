...
public class ParserWriteStatusItemAmb {
	...
	public ParserWriteStatusItemAmb(String nomeOperacao, String zcaCodAmb, String zcaTipAmb, String zcaItem, String zcaParam) {
		
		
		String writeStr = nomeOperacao + "#" + zcaCodAmb + "#" + zcaTipAmb + "#" + zcaItem + "#" + zcaParam + "#\0";
